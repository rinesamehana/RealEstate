...
export default observer(function ShtetiDetails() {
  const { shtetiStore } = useStore();

  const { selectedShteti: shteti, loadShtet, loadingInitial } = shtetiStore;
  ...
  if (loadingInitial || !shteti) return <LoadingComponent />;
  return (
    <div className="new">
      <Sidebar />
